...
> "Let me check the status of your worktrees... I see the issue - [explain problem and solution]"
...
### What to tell the user
> "Here are the access URLs for your worktree: Dashboard: http://localhost:[CLIENT_PORT]/dashboard; Server API: http://localhost:[SERVER_PORT]; Client: http://localhost:[CLIENT_PORT]"
